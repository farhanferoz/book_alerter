...
**Last update:** 2026-05-23, NAS deployment + production-bug sweep + browser-driven follow-up fixes. All tests green: **417 unit/integration (+22 over previous baseline) + 7/7 scenarios + ruff clean + FE TS+ESLint+build clean + 0 FK violations + alembic head `0017_views_freshness_gate`**. Live deployment at **http://100.115.46.9:8090** (Tailscale-only) running `ghcr.io/farhanferoz/book_alerter:latest` (image built from `d70d874`).
